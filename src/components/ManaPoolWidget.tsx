...
export default function ManaPoolWidget() {
    ...
    return (
        <motion.div
            ...
            className="fixed bottom-64 right-4 z-50 cursor-grab active:cursor-grabbing"
            whileDrag={{ scale: 1.02 }}
        >
            <div className="bg-gray-900/90 backdrop-blur-sm border border-gray-700 rounded-xl p-2 shadow-2xl">
                {/* Drag Handle */}
                <div className="absolute -top-2 left-1/2 -translate-x-1/2 w-8 h-1 bg-gray-600 rounded-full opacity-50" />
